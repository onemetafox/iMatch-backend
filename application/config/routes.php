...
$route['api/v1/add_bestie']['post']              = 'api/v1/User/add_bestie';
...
$route['api/v1/MatchUpload']['post']                 = 'api/v1/User/MatchUpload';
...
$route['api/v1/personallike']['post']                 = 'api/v1/User/personallike';
